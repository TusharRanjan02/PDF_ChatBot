...
with st.sidebar:
    ...
    backend_url = st.text_input("Backend URL", DEFAULT_BACKEND, key="sidebar_backend_url")
...
if prompt:
    ...
    backend_url = st.sidebar.text_input("Backend URL", DEFAULT_BACKEND)  # read latest
